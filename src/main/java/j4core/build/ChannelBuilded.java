...
import j4core.entity.chan.ChannelsListFromArray;
...
public final class ChannelBuilded {
    private final List<Pair<DevName, ChannelsListFromArray>> origin;

    public ChannelBuilded() {
        origin = arrayListTestEnvironment();
        //origin = arrayListEcoAlliance();
    }

    public List<Pair<DevName, ChannelsListFromArray>> list() {
        return origin;
    }

    public  Map<ChanName, Integer> mapChanCount() {
    ...
    private List<Pair<DevName, ChannelsListFromArray>> arrayListEcoAlliance() {
        return Arrays.asList(
                // AIK1
                new Pair<>(AIK1,
                    new ChannelsListFromArray(
    ...
    private List<Pair<DevName, ChannelsListFromArray>> arrayListTestEnvironment() {
        return Arrays.asList(
            new Pair<>(AO1,
                new ChannelsListFromArray(
