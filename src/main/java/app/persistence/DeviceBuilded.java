    ...
    public static ArrayList<Triplet<String, WadDevType, Integer>>  buildEcoAlliance()  {
        return
            new ArrayList<Triplet<String, WadDevType, Integer>>() {{
                add(new Triplet<>(Dv.AIK1, WadDevType.AIK, Id.x21)); // dry
                add(new Triplet<>(Dv.AIK2, WadDevType.AIK, Id.x22)); // dry
                ...
                add(new Triplet<>(Dv.AO1, WadDevType.AO6, Id.x41)); // dry
                add(new Triplet<>(Dv.AO2, WadDevType.AO6, Id.x42)); // dry
            }};
    }
